            ...
            {filteredProjects.map((proj) => (
              ...
              >
                ...
                <td className="py-3.5 px-4 font-bold text-emerald-600">
                  ¥{((proj.budget ?? proj.contractAmount ?? 0) / 10000).toFixed(0)}万
                </td>
            ...
            <div className="grid grid-cols-2 gap-4 bg-slate-50 dark:bg-slate-800/60 p-4 rounded-xl">
              ...
              <div>
                ...
                <span className="font-bold text-slate-900 dark:text-white text-base">
                  ¥{((activeProject.budget ?? activeProject.contractAmount ?? 0) / 10000).toFixed(0)} 万元
                </span>
              </div>
              <div>
                <span className="text-slate-400 block">已发生支出成本</span>
                <span className="font-bold text-emerald-600 dark:text-emerald-400 text-base">
                  ¥{((activeProject.spentBudget ?? activeProject.spentCost ?? 0) / 10000).toFixed(0)} 万元
                </span>
              </div>
            </div>
