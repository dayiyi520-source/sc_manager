...
export const CRMContractsView: React.FC = () => {
  const { contracts, addContract, updateContract, customers, openPageTab, addToast } = useAppCrm();
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <ListToolbar searchValue={searchQuery} onSearchChange={setSearchQuery} searchPlaceholder="搜索合同编号、名称、客户..." filters={<>
          <select
            value={typeFilter}
