...
export const CRMBiddingView: React.FC = () => {
  const { biddings: biddingProjects, addBiddingProject, updateBiddingProject, customers, opportunities, openPageTab, addToast } = useAppCrm();
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <ListToolbar searchValue={searchQuery} onSearchChange={setSearchQuery} searchPlaceholder="搜索编号、项目名称、客户..." filters={<>
          <select
            value={statusFilter}
