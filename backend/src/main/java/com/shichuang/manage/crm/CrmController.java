...
public class CrmController {
    ...
    @PutMapping("/opportunities/{id}/bidding")
    public ApiResponse<Map<String, Object>> updateBidding(@PathVariable String id, @RequestBody Map<String, Object> body) {
        return ApiResponse.ok(service.updateBidding(id, body));
    }

    @PutMapping("/biddings/{id}/engagement")
    public ApiResponse<Map<String, Object>> updateEngagement(@PathVariable String id, @RequestBody Map<String, Object> body) {
        return ApiResponse.ok(service.updateEngagement(id, body));
    }

    @GetMapping("/biddings")
    public ApiResponse<PageResult<Map<String,Object>>> biddings(@RequestParam(defaultValue="1") int page, @RequestParam(defaultValue="20") int pageSize) { return ApiResponse.ok(service.biddings(page,pageSize)); }

    @GetMapping("/winning-engagements")
    public ApiResponse<PageResult<Map<String,Object>>> engagements(@RequestParam(defaultValue="1") int page, @RequestParam(defaultValue="20") int pageSize) { return ApiResponse.ok(service.engagements(page,pageSize)); }
