...
public class OkrController {
 ...
 @GetMapping("/actions/parents") @Operation(summary="查询可拆解的上级动作") public ApiResponse<List<Map<String,Object>>> actionParents(@RequestParam String periodKey){return ApiResponse.ok(service.actionParents(periodKey));}
