...
public class RequirementController {
    ...
    @PostMapping("/{id}/reopen") public ApiResponse<Map<String,Object>> reopen(@PathVariable String id,@RequestBody Map<String,Object>b){return ApiResponse.ok(assistanceWorkflow.reopen(id, ((Number)b.getOrDefault("progress",0)).intValue(), ((Number)b.getOrDefault("revision",0)).intValue(), String.valueOf(b.getOrDefault("reason", ""))));}
