...
public class ProductLineController {
 ...
 @PostMapping("/{id}/work-item-types") @ResponseStatus(HttpStatus.CREATED) public ApiResponse<Map<String,Object>> addWorkItemType(@PathVariable String id,@RequestBody WorkItemDefinition.CreateWorkItemType body){return ApiResponse.ok(service.addWorkItemTypeWithWorkflow(id,body));}
