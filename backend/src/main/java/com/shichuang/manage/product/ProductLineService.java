...
public class ProductLineService {
 ...
 @Transactional public Map<String,Object> addWorkItemTypeWithWorkflow(String id,WorkItemDefinition.CreateWorkItemType input){
  ...
  private void initializeWorkItemTemplate(String id){
   for(WorkItemTemplate.Type type:WorkItemTemplate.types()) addWorkItemTypeWithWorkflow(id,new WorkItemDefinition.CreateWorkItemType(type.category(),type.name(),"",true,type.isDefault(),WorkItemTemplate.workflow(type)));
  }
