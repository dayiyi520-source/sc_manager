...
export const MENU_GROUPS: MenuGroup[] = [
  {
    ...
    subMenus: [
      { id: 'wb_my_tasks', title: '我的任务', icon: 'CheckSquare' },
  ...
  },
  {
    ...
    subMenus: [
      ...
      { id: 'crm_opportunities', title: '商机管理', icon: 'TrendingUp' }
    ]
  },
  {
    id: 'product',
  ...
  },
  {
    ...
    icon: 'Boxes',
    subMenus: [
      { id: 'approval_center', title: '审批中心', icon: 'Stamp' },
