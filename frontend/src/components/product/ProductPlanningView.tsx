    ...
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-blue-600 font-medium">主干 V4.2.0</span>
        </div>
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-slate-400">占比 {Math.round((inProgressReqs / totalReqs) * 100)}%</span>
        </div>
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-slate-400">PRD 评审完结</span>
        </div>
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-slate-400">核心攻坚中</span>
        </div>
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-slate-400">自动化回归中</span>
        </div>
        <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-xs">
          ...
          <span className="text-[10px] text-emerald-600 font-medium">验收达成</span>
        </div>
      </div>
