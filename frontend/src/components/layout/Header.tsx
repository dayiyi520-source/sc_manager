...
export const Header: React.FC = () => {
  ...
  return (
    <header className="tech-header h-14 border-b px-4 flex items-center justify-between sticky top-0 z-30 select-none">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0 hidden sm:block">
            <div className="font-semibold text-sm tracking-wide text-white flex items-center gap-1.5 truncate">
              师创管理后台
              <span className="tech-pro-badge text-[9px] px-1.5 py-0.5 border rounded font-mono font-medium">
                PRO
              </span>
            </div>
            <div className="text-[10px] text-[var(--text-muted)] truncate font-sans">数字化协同与经营平台</div>
          </div>
        </div>

        <div className="hidden md:flex items-center gap-1.5 px-2.5 py-0.5 bg-emerald-950/30 border border-emerald-800/40 rounded-full text-[11px] font-medium text-emerald-400">
