          ...
          <div className="space-y-4">
            {filteredOkrs.length === 0 ? (
              <div className="review-empty-state flex flex-col items-center justify-center rounded-xl border border-dashed p-10 sm:p-14 text-center">
                <div className="review-empty-icon mb-4 flex h-14 w-14 items-center justify-center rounded-2xl"><Target className="h-7 w-7" /></div>
      ...
      {mainTab === 'reviews' && (
        <div className="space-y-6">
          ...
          {reviewSubTab === 'write' && !isReviewFormOpen && (
            <div className="review-empty-state flex flex-col items-center justify-center rounded-xl border border-dashed p-10 sm:p-14 text-center">
              <div className="review-empty-icon mb-4 flex h-14 w-14 items-center justify-center rounded-2xl">
